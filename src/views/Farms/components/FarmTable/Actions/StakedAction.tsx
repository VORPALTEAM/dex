import { AddIcon, Button, Heading, IconButton, MinusIcon, Skeleton, Text, useModal } from 'vorpaltesttoolkit'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  if (!account) {
    return (
      <ActionContainer>
        <ActionTitles>
          <Text bold textTransform="uppercase" fontFamily="RobotoBold" color="text" fontSize="12px">
            {t('Start Farming')}
          </Text>
        </ActionTitles>
        <ActionContent>
  ...
  if (isApproved) {
    if (stakedBalance.gt(0)) {
      return (
        <ActionContainer>
          <ActionTitles>
            <Text bold textTransform="uppercase" fontFamily="RobotoBold" color="text" fontSize="12px" pr="4px">
              {lpSymbol}
            </Text>
            <Text bold textTransform="uppercase" fontFamily="RobotoBold" color="text" fontSize="12px">
              {t('Staked')}
          ...
          <ActionContent>
            ...
            <IconButtonWrapper>
              <StyledIconButton variant="secondary" onClick={onPresentWithdraw} mr="6px">
                <MinusIcon color="backgroundAlt1" width="24px" />
              </StyledIconButton>
              <StyledIconButton
                variant="secondary"
              ...
              >
                <AddIcon color="backgroundAlt1" width="24px" />
              </StyledIconButton>
            </IconButtonWrapper>
          </ActionContent>
        </ActionContainer>
